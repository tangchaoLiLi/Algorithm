...
public class DataClassificationProcessing {
    public static void main(String[] args) {
        int[] list = new int[]{15, 123, 456, 786, 453, 46, 7, 5, 3, 665, 453456, 745, 456, 786, 453, 123};
        int[] counts = new int[]{5,6,3,6,3,0};
        List<Integer> countsList = new ArrayList<>();
        for (int i=1;i<counts.length;i++) {
            countsList.add(counts[i]);
        }
        //去重
        List<Integer> collect = countsList.stream().distinct().collect(Collectors.toList());
